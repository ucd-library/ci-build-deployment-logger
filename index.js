...
async function run() {
  ...
  let data = {
    ...
    _UCD_LIB_INITIATOR : process.env._UCD_LIB_INITIATOR || '',
    _GITHUB_EVENT : process.env._GITHUB_EVENT || '',
    _GITHUB_ISSUE_NUMBER : process.env._GITHUB_ISSUE_NUMBER || '',
    _GITHUB_REPOSITORY : process.env._GITHUB_REPOSITORY || '',
    _GITHUB_PR_USER : process.env._GITHUB_PR_USER || '',
    _GITHUB_PR_MERGED_BY : process.env._GITHUB_PR_MERGED_BY || '',
